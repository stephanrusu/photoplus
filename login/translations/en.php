...
define("MESSAGE_RESET_EMAIL_EMPTY", "Email address field was empty");

// views
define("WORDING_BACK_TO_LOGIN", "Back to Login Page");
define("WORDING_BACK_TO_PROFILE", "Back to Profile Page");
define("WORDING_VIEW_PROFILE","View Profile");
...
define("WORDING_NEW_EMAIL", "New email address");
define("WORDING_NEW_PASSWORD", "New password");
define("WORDING_NEW_PASSWORD_REPEAT", "New password");
define("WORDING_NEW_USERNAME", "New username (username cannot be empty and must be a-z, A-Z, 0-9 and 2-64 characters)");
...
define("WORDING_REQUEST_PASSWORD_RESET", "Not to worry. Just enter your email address below and we'll send you an instruction email for recovery.");
define("WORDING_RESET_PASSWORD", "Reset my password");
define("WORDING_RESET_PASSWORD_TITLE","Forgot your password?");
