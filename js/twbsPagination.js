...
(function ($, window, document, undefined) {
    ...
    $.fn.twbsPagination.defaults = {
        ...
        hrefVariable: '{{number}}',
        first: '<i class="fa fa-backward fa-fw"></i> First',
        prev: '<i class="fa fa-chevron-left fa-fw"></i> Previous',
        next: 'Next <i class="fa fa-chevron-right fa-fw"></i>',
        last: 'Last <i class="fa fa-forward fa-fw"></i>',
